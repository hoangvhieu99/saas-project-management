...
Session 06 đã xong (Dashboard summary widgets). Coding session tiếp theo xem `NEXT_SESSION.md` — **không tự advance**.

## Feature đang làm

Dashboard — `docs/features/dashboard.md` · lịch sử workspace Session 06 trong `docs/explanations/workspace.md`
...
- Session 06: Dashboard stat widgets (total / owner / member derived)
- Docs: `dashboard.md`, review session-06
...
- [ ] Session 07 — xem `NEXT_SESSION.md`
